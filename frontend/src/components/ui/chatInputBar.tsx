...
import { Text, View, TextInput, Pressable, KeyboardAvoidingView, Platform, Modal} from "react-native";
...
export default function ChatInputBar({ onSend, isWaiting = false }: Props) {
  ...
  const handleSend = () => {
    ...
    return (
      ...
      >
        <View className="flex-col w-full  gap-2 p-2 bg-white rounded-lg shadow-md">
            <TextInput
            ...
            <Pressable
              ...
              className="flex-row items-center gap-1 px-3 py-2 rounded-lg bg-background-element"
            >
